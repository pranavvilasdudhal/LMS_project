    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                <a href="/home" class="navbar-brand mx-2 mb-1">
                    <h3 class="text-primary"><i class="fa fa-hashtag me-3"></i>DASHMIN</h3>
                </a>
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="{{ route('subject.index') }}" class="nav-item nav-link"><i
                            class="fa fa-keyboard me-2"></i>Subject table</a>
